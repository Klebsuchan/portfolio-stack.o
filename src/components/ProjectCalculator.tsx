            ...
            <div>
              <label className="flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded-xl cursor-pointer hover:bg-white/10 transition-colors">
                <div className="flex items-center gap-3">
                  <Cpu size={20} className={aiIntegration ? "text-neon-blue" : "text-gray-500"} />
                  <div>
                ...
                <div className={`w-12 h-6 rounded-full transition-colors relative ${aiIntegration ? 'bg-neon-blue' : 'bg-gray-700'}`}>
          ...
          <div className="w-full md:w-[350px] bg-black/40 rounded-2xl border border-white/5 p-8 flex flex-col justify-center items-center text-center relative overflow-hidden">
            ...
            <div className="text-5xl font-black text-white mb-2 flex items-baseline gap-2">
              <motion.span 
                ...
                className="text-transparent bg-clip-text bg-gradient-to-br from-neon-blue to-neon-purple"
              >
                ~{estimateText}
              </motion.span>
